...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    name: Attribute.String;
    verifyStatus: Attribute.Integer;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    blogcontents: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::blog-content.blog-content'
    >;
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    ...
    workType: Attribute.Enumeration<['Online', 'Offline']> & Attribute.Required;
    startDate: Attribute.Date;
    duration: Attribute.Integer;
    tags: Attribute.JSON;
    applyBy: Attribute.Date;
    aboutCompany: Attribute.RichText;
    aboutWorkRequirements: Attribute.RichText;
    whoCanApply: Attribute.RichText;
    perks: Attribute.JSON;
    noOfOpenings: Attribute.Integer;
    recuriterDetails: Attribute.RichText;
    stipend: Attribute.String;
    WorkCity: Attribute.String;
    durationType: Attribute.Enumeration<['Week', 'Month']>;
    skillsRequired: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiWorkshopWorkshop extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dateScheduled: Attribute.DateTime;
    description: Attribute.RichText;
    authorDescription: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
